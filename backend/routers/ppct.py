...
Nhiệm vụ tối quan trọng: Đọc kỹ ảnh chụp bảng Phân phối chương trình (PPCT) môn {subject} {grade} và trích xuất TOÀN BỘ VÀ CHÍNH XÁC 100% danh sách từng tiết bài dạy thành mảng JSON.

================ QUY TẮC NHẬN DIỆN CẤU TRÚC BẢNG PPCT ================

Tài liệu PPCT ở trường học thường có 2 dạng chính, bạn phải tự động nhận diện:
